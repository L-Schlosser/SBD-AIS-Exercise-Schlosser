...
func prepopulate(dbConn *gorm.DB) error {
	...
	// todo create drinks
	drinks := []model.Drink{
		{Name: "Coca-Cola", Price: 2.50, Description: "Classic Coke"},
		{Name: "Pepsi", Price: 2.50, Description: "softdrink"},
		{Name: "Water", Price: 1.00, Description: "still water"},
		{Name: "Orange Juice", Price: 3.00, Description: "juice"},
	}
